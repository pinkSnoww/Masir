...
export default async function handler(req, res) {
  try {
    ...
    // Get categories with auth cookies
    const categoriesResponse = await api.get('http://171.22.25.164/api/academy/categories/', {
      headers: {
    ...
    return res.status(200).json(categoriesResponse.data);
  } catch (error) {
