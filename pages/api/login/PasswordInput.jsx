    ...
    <div className="flex flex-col justify-center w-full">
      ...
      <div className="flex gap-2 justify-center items-center self-stretch p-2 my-auto w-10">
        ...
        <input
          type="password"
          id={`password-${label}`}
          className="flex-1 shrink gap-2 self-stretch my-auto text-base text-left font-extralight bg-transparent border-none outline-none min-w-[240px] text-neutral-300"
          placeholder="********"
          aria-label={label}
        />
         <div className="flex gap-2 justify-center items-center self-stretch p-2 my-auto w-10">
